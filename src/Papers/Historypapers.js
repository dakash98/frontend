        ...
        <div id='parent' className='relative'>
          <div id='go' className=' top-0 w-full mt-[50px]'>
            <div className='w-[50%] ml-[25%] pb-[5%] pr-[10%]'>
              <h1 className='ml-[37%] text-3xl font-bold text-white'>History And Political Science</h1>
                      ...
                      {item.papers.map((item1, index1) =>
                        <div className='flex ml-[15%]'>
                          <div className='block'>
                            ...
                            <button onClick={event => handleSolution("not_logged_in", index1, index)}  className='rounded-xl w-[300px] text-white h-[50px] text-center font-medium mt-[25px] bg-[#5591A9]' key={index}>{item.papers[index1]['name']} Solution</button>
                          </div>
                        </div>)}
                    </div>
                  </div>)}
