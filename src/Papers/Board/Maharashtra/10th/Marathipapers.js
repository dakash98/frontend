...
function MarathiPapers() {
  ...
  const fetchdata = async (url) => {
    try {
      ...
      // localStorage.setItem("data_marathi_" + localStorage.getItem('medium'), JSON.stringify(data));
  ...
  useEffect(() => {
    ...
    // const timestamp = localStorage.getItem('timestamp_marathi_' + localStorage.getItem('medium'));
    // const data_marathi = localStorage.getItem('data_marathi_' + localStorage.getItem('medium'));
    ...
    //     localStorage.removeItem('timestamp_marathi_' + localStorage.getItem('medium'));
    //     localStorage.removeItem('data_marathi_' + localStorage.getItem('medium'));
    ...
    //     localStorage.setItem('timestamp_marathi_' + localStorage.getItem('medium'), JSON.stringify({
    //       value: "string",
    //       expDate: date,
    //     }))

    //     fetchdata(API_hisory_paper);
    //   } else if(localStorage.getItem('data_marathi_' + localStorage.getItem('medium'))) {
    //     const object = JSON.parse(localStorage.getItem('data_marathi_' + localStorage.getItem('medium')))
    //     setData(object.data)
    //     document.getElementById("loader").classList.add("hidden");
    //     document.getElementById("parent").classList.remove("hidden");
    //     document.getElementById("explore").classList.remove("hidden");
  ...
  return (
    <div className="relative z-0">
      <Helmet>
        ...
        <link rel="canonical" href="https://padhaiplanet.com/maharashtra-board-marathi-question-papers-10th-ssc" />
        <meta name="description" content="Prepare for your exam with our Marathi question paper for the Maharashtra 10th SSC board. Prepare with the best resources and boost your chances of success in Maharashtra 10th SSC boards by practicing the previous year's question papers for 2018,2019,2020,2022,2023." />
        <meta name="keywords" content="10th SSC Maharashtra board question papers, Last 5 years question papers, Class 10 th Maharashtra board Marathi question paper and Solutions., Question paper pdf., 10th Standard Board exam., Maharashtra Board questions paper all classes., Maharashtra Board Question and Solutions." />
      </Helmet>
