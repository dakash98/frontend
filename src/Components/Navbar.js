  ...
  return (
    <div className="flex items-center justify-between w-full px-4 md:px-8 py-4 gradient-bg">
      <div className="flex items-center">
        ...
        <h1 className="text-white md:text-6xl text-3xl font-bold">PadhaiPlanet</h1>
      </div>
      {/* Navigation Links for Wider Screens */}
      <div className="hidden md:flex md:items-center">
        <Link to="/about-us" className="zoom-effect nav-link" onClick={closeMenu}>About Us</Link>
        <Link to="/blogs" className="zoom-effect nav-link" onClick={closeMenu}>Blogs</Link>
        <Link to="/contact-us" className="zoom-effect nav-link" onClick={closeMenu}>Contact Us</Link>
        <Link to="/profile" className="nav-link" onClick={closeMenu}>Login</Link>
      </div>
      ...
      <div className={`absolute top-full right-0 bg-gradient-to-r from-gray-800 via-gray-900 to-black p-4 rounded-md shadow-lg ${showMenu ? "block" : "hidden"} md:hidden`}>
        <Link to="/about-us" className="nav-link block mb-2" onClick={closeMenu}>About Us</Link>
        <Link to="/blogs" className="nav-link block mb-2" onClick={closeMenu}>Blogs</Link>
        <Link to="/contact-us" className="nav-link block mb-2" onClick={closeMenu}>Contact Us</Link>
        <button
